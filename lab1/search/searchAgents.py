...
class PositionAndCoinsSearchProblem(search.SearchProblem):
    """
    A search problem defines the state space, start state, goal test, successor
    function and cost function.  This search problem can be used to find paths
    to a particular point on the pacman board.
    ...
    def __init__(self, gameState, costFn=lambda x: 1, goal=(1, 1), start=None, visualize=True):
        """
        Stores the start and goal.
        ...
        for direction in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextx][nexty]:
                ...
                if nextFood[nextx][nexty] == True:
                    ...
                    successors.append((((nextx, nexty), nextFood), direction, 0.5))
                else:
                    nextFood[nextx][nexty] = False
